...
import { companyResponseInterface, serviceInterface } from 'src/app/models/interfacesResponse';
...
export class HomePage implements OnInit {
  ...
  async listingQuestions() {
    try {
      ...
      const resp: serviceInterface[] = await this.serviceService.getService();
